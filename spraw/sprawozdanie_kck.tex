...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \caption[]%
        {{\small i ze znalezionymi kluczami (średnie)}}
        \label{fig:sub2}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \includegraphics[width=\textwidth]{nutki_17.jpg}
        \caption[]%
        {{\small próbka 17 przed procesem}}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \caption[]%
        {{\small próbka 21 przed procesem}}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \caption[]%
        {{\small próbka 27 przed procesem}}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        \includegraphics[width=\textwidth]{nutki_30.jpg}
        \caption[]%
        {{\small próbka 30 przed procesem}}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.475\textwidth}
